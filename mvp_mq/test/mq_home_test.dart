...
void main() {
  ...
  testWidgets('MQHome builds correctly', (WidgetTester tester) async {
   ...
   testWidgets('Navigates to SelectCampus on tapping Parking Spot button', (WidgetTester tester) async {
    await tester.pumpWidget(createWidgetUnderTest());
   ...
   testWidgets('Navigates to MapWidget on tapping Wallumattagal Campus Map button', (WidgetTester tester) async {
    await tester.pumpWidget(createWidgetUnderTest());
