...
void main() {
  ...
  testWidgets('Email and password fields accept input',
    ...
    await tester.enterText(
        find.widgetWithText(TextFormField, 'Email'), emailText);
    await tester.enterText(
        find.widgetWithText(TextFormField, 'Password'), passwordText);
    await tester.pump();
  ...
  testWidgets('Navigates to SignupScreen when signup link is tapped',
      (WidgetTester tester) async {
    await tester.pumpWidget(createTestableWidget());
